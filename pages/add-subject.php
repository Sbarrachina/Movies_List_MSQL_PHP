...
<form method="post" >
			...
			<div class="row">
				<div class="col-lg-12">
					<div class="panel panel-default">
						<div class="panel-heading">Agregar datos pelicula</div>
							...
							<div class="row">
						 	<div class="col-lg-10">
										...
										<div class="form-group">
											<div class="col-lg-4">
					 <label>Nombre Película<span id="" style="font-size:11px;color:Red">*</span>	</label>
											</div>
	...
	<input type="submit" class="btn btn-primary" name="submit" value="Añadir "></button>
											</div>
