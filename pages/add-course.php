...
body{
	...
	#page-wrapper{
		background-image: url(../img/blanco.jpeg);
...
<!--nav-->
							...
							<div class="row">
						 	<div class="col-lg-10">
										...
										<div class="form-group">
											<div class="col-lg-4">
					 <label>Película<span id="" style="font-size:11px;color:red">*</span>	</label>
											</div>
											<div class="col-lg-6">
  ...
  <input class="form-control" name="course-short" id="cshort" required="required"  onblur="courseAvailability()">       
		...
		<div class="form-group">
		<div class="col-lg-4">
		<label>Director<span id="" style="font-size:11px;color:red">*</span></label>
		</div>
		<div class="col-lg-6">
	...
	<div class="col-lg-6">
	<input class="form-control" value="<?php echo date('Y');?>"  name="cdate">
		...
		<br><br>		
							...
							<input type="submit" class="btn btn-primary" name="submit" value="Crear Película"></button>
											</div>
